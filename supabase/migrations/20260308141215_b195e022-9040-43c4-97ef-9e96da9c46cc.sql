...
BEGIN
  ...
  -- Event tastings: join via user_wine_notice_event, coords from event
  SELECT
    uwn.id,
    uwn.wine_id,
    w.name AS wine_name,
  ...
  -- Cellar tastings: join via user_wine_notice_cellar, coords from cellar
  SELECT
    uwn.id,
    uwn.wine_id,
    w.name AS wine_name,
  ...
  -- Spontaneous tastings: coords directly on user_wine_notice
  SELECT
    uwn.id,
    uwn.wine_id,
    w.name AS wine_name,
