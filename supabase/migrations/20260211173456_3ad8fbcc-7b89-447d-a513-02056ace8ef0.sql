...
BEGIN
  ...
  INSERT INTO wine (name, domain_id, year, volume_ml, price, description, label_url, alcohol_percentage, type, appellation_id, is_playable, cepages)
  VALUES (p_name, p_domain_id, p_year, p_volume_ml, p_price, p_description,
          ...
          p_alcohol_percentage, p_type, p_appellation_id, p_is_playable, p_cepages)
