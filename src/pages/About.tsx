...
const FEATURES = [
  {
    ...
    title: "Réseau Social",
    description:
      "Partagez vos découvertes œnologiques, suivez des passionnés et échangez avec une communauté bienveillante.",
  ...
  },
  {
    ...
    title: "Dégustations",
    description:
      "Notez chaque vin dégusté, gardez une trace de vos impressions et retrouvez facilement vos coups de cœur.",
  ...
  },
  {
    ...
    title: "Jeux Festifs",
    description:
      "Animez vos soirées avec des jeux de dégustation à l'aveugle, de 1 à 8 joueurs, pour tous les niveaux.",
  ...
  },
  {
    ...
    title: "Événements",
    description:
      "Découvrez des dégustations près de chez vous, organisez vos propres événements et rencontrez d'autres amateurs.",
...
const VALUES = [
  {
    ...
    title: "Passion",
    description:
      "Le vin est notre passion, et nous la partageons avec authenticité et enthousiasme à travers chaque fonctionnalité.",
  },
  {
    icon: Users,
    title: "Communauté",
    description:
      "Nous créons des liens entre amateurs et professionnels du monde viticole, dans un esprit de partage et de convivialité.",
  },
  {
    icon: BookOpen,
    title: "Apprentissage",
    description:
      "Nous rendons la connaissance du vin accessible à tous, de manière ludique, interactive et sans prétention.",
  },
];
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center animate-fade-up">
              ...
              <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-6">
                WineNote est née de la volonté de{" "}
                <strong className="text-foreground">démocratiser l'univers du vin</strong> et de créer une communauté où
                passionnés et amateurs peuvent échanger, apprendre et découvrir ensemble.
              </p>
              <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                Nous croyons que le vin est bien plus qu'une boisson : c'est un{" "}
                <strong className="text-foreground">art, une culture, un patrimoine</strong> à préserver et à partager.
                Notre plateforme permet à chacun de gérer sa cave, de participer à des événements, et d'approfondir ses
                connaissances à travers des cours interactifs.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {FEATURES.map((feature, index) => (
                ...
                >
                  <CardHeader>
                    <div
                      className={`inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br ${feature.gradient} mb-4 group-hover:scale-110 transition-transform duration-300`}
                    >
                ...
                <div className="md:flex items-center">
                  ...
                  <div className="md:w-2/3 p-8">
                    ...
                    <p className="text-muted-foreground leading-relaxed mb-4">
                      Passionné de vin et de technologie, j'ai créé WineNote pour partager ma passion et permettre à
                      chacun de découvrir l'univers fascinant de l'œnologie.
                    </p>
                    <p className="text-muted-foreground leading-relaxed">
                      L'idée est née d'un constat simple : le monde du vin peut sembler intimidant pour les novices.
                      WineNote a pour ambition de le rendre accessible, ludique et convivial pour tous.
                    </p>
                  </div>
                </div>
              </Card>
